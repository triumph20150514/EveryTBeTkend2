...
import jp.co.recruit_lifestyle.android.widget.DropBounceInterpolator;
...
public class WaveView extends View implements ViewTreeObserver.OnPreDrawListener {
     ...
     * 円のRadius
     */
    private float mDropCircleRadius = 50;
    ...
    public void startWaveAnimation(float h) {
        ...
        mWaveReverseAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                mWavePath.moveTo(0, 0);
                mWavePath.quadTo(0.25f * mWidth, 0, 0.333f * mWidth, h * 0.5f);   //前面的为控制点的坐标
